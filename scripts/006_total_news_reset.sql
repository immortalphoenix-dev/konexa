-- TOTAL NEWS CONTENT RESET & PREMIUM RE-SEED
-- Use this script to clear ALL stale articles and start fresh with 8 premium entries.
-- This script uses 'DELETE' to bypass constraint issues and ensure a clean slate.

-- 1. Ensure schema is updated
ALTER TABLE public.articles ADD COLUMN IF NOT EXISTS gallery_images JSONB DEFAULT '[]'::jsonb;

-- 2. Nuke everything in the articles table
DELETE FROM public.articles;

-- 3. Insert 8 Premium, High-Impact Articles
